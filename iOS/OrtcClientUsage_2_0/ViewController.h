...
@interface ViewController : UIViewController<OrtcClientDelegate, UITabBarDelegate>
{
@private
...
@property (nonatomic, retain) IBOutlet UITextField *txtControlBox;
